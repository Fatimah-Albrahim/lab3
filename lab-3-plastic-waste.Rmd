...
Answer here:
because here we represent a set of date (continents),not just color control,as the colers here belong to the continents,and talking about all graphic (gemo_density)
